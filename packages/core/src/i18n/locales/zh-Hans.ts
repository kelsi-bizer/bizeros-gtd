...
export const zhHans: Record<string, string> = {
        ...
        'settings.title': '设置',
        'settings.subtitle': '自定义您的 BizerOS GTD 体验',
        ...
        'settings.closeBehaviorPromptTitle': '关闭 BizerOS GTD？',
        'settings.closeBehaviorPromptBody': '要让 BizerOS GTD 保持在托盘运行，还是直接退出？',
        ...
        'settings.webdavHint': '请填写同步文件夹地址，BizerOS GTD 会在其中存放 data.json。',
        ...
        'settings.cloudBaseUrlHint': '填写基础地址，BizerOS GTD 会自动加上 /v1/data。',
        ...
        'digest.morningBody': '打开 BizerOS GTD 规划今天。',
        'digest.eveningTitle': '晚间回顾',
        'digest.eveningBody': '打开 BizerOS GTD 进行回顾与收尾。',
        'digest.weeklyReviewTitle': '每周回顾',
        'digest.weeklyReviewBody': '打开 BizerOS GTD 进行每周回顾。',
        ...
        'settings.globalQuickAddShortcutDesc': '用于系统级快速收集，即使 BizerOS GTD 未聚焦也可触发。',
        ...
        'settings.aiConsentDescription': '要使用此功能，您的任务数据将发送到 {provider} 进行处理。该数据受其隐私政策约束。BizerOS GTD 不会收集这些数据。是否继续？',
        ...
        'settings.calendarSystemDeniedHint': '日历访问被拒绝。请在 macOS 系统设置 > 隐私与安全性 > 日历 中为 BizerOS GTD 开启权限。',
        ...
        'obsidian.taskNotesDetectedBody': '检测到 Task Notes 格式。你可以继续沿用它，或切换到 BizerOS GTD 的原生格式。',
