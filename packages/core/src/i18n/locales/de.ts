...
export const deOverrides: Record<string, string> = {
        ...
        'settings.subtitle': 'Passen Sie Ihr BizerOS GTD-Erlebnis an',
        ...
        'settings.closeBehaviorPromptTitle': 'BizerOS GTD schließen?',
        'settings.closeBehaviorPromptBody': 'Wollen Sie BizerOS GTD im Taskbereich weiterlaufen lassen oder ganz schließen?',
        ...
        'settings.webdavHint': 'Geben Sie einen Ordner an; BizerOS GTD speichert darin data.json.',
        ...
        'digest.morningBody': 'Öffnen Sie BizerOS GTD, um Ihren Tag zu planen.',
        'digest.eveningTitle': 'Abendliche Revision',
        'digest.eveningBody': 'Öffnen Sie BizerOS GTD, um Ihren Tag Revue passieren zu lassen und zusammenzufassen.',
        'digest.weeklyReviewTitle': 'Wöchentliche Revision',
        'digest.weeklyReviewBody': 'Öffnen Sie BizerOS GTD, um Ihre Woche Revue passieren zu lassen und neue Ziele zu setzen.',
        ...
        'settings.globalQuickAddShortcutDesc': 'Wird systemweit für eine schnelle Erfassung verwendet, auch wenn BizerOS GTD nicht fokussiert ist.',
        ...
        'settings.aiConsentDescription': 'Wenn Sie diese Funktion nutzen, werden Ihre Aufgaben-Daten an {provider} zur Verarbeitung gesendet. Diese Daten werden gemäß ihrer Datenschutzbestimmungen behandelt. BizerOS GTD sammelt diese Daten nicht. Möchten Sie fortfahren?',
        ...
        'settings.calendarSystemDeniedHint': 'Kalenderzugriff wurde abgelehnt. Aktivieren Sie BizerOS GTD in den macOS-Systemeinstellungen unter „Datenschutz & Sicherheit“ > „Kalender“.',
        ...
        'settings.linuxUpdateHint': 'Unter Linux kann BizerOS GTD Aktualisierungen nicht automatisch installieren. Installieren Sie das Programm nach dem Herunterladen über Ihren Paketmanager (z. B. `yay -S mindwtr` oder `paru -S mindwtr`) oder direkt das heruntergeladene Paket.',
